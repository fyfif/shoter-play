...
class Player(GameSprite): 
    def update(self): 
        ...
        if key_pressed[K_a] and self.rect.x > 0: 
            self.rect.x -= self.speed 
    def fire(self): 
        bullet = Bullet('picca.png', self.rect.centerx, self.rect.top, 30, 30 ,10) 
        bullets.add(bullet)
...
player = Player('Tank2.png', 375, 400, 80, 100, 5) 
bullet = Bullet('picca.png', 375, 400, 10, 20, 5 ) 

bullets = sprite.Group()
monsters = sprite.Group() 

for i in range(1, 6): 
    monster = Enemy('freddi.png', randint(0,700-80), 0, 80, 50, 1) 
...
backgound = transform.scale(image.load('forest2.jpg'), (700,500)) 
...
win_text = font2.render("ура победа", True, (255,255,255))
lose_text = font2.render("ура поражение", True, (255,255,255))
